...
func TestDataSourceIbmLogsAlertDefinitionsAlertDefinitionToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		...
		apisAlertDefinitionLogsThresholdConditionModel["condition_type"] = "more_than_or_unspecified"
	...
	apisAlertDefinitionLogsThresholdConditionModel.ConditionType = core.StringPtr("more_than_or_unspecified")
