...
You can import the `ibm_logs_data_access_rule` resource by using `id`. Data Access Rule ID.

# Syntax
<pre>
$ terraform import ibm_logs_data_access_rule.logs_data_access_rule &lt;id&gt;
</pre>

# Example
```
$ terraform import ibm_logs_data_access_rule.logs_data_access_rule 3dc02998-0b50-4ea8-b68a-4779d716fa1f
```
